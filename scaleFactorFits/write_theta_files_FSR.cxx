...
void write_theta_files_FSR(){
  ...
  TString InputPathPUPPI = "/nfs/dust/cms/user/dreyert/RunII_94X_v1/PostSelection_Nov18/AK8PUPPI/";
  TString InputPathCHS =   "/nfs/dust/cms/user/dreyert/RunII_94X_v1/PostSelection_Nov18/AK8CHS/";
  TString InputPathHOTVR = "";
  TString OutputPath = "./";
  ...
  std::vector< vector<TString> > systematics {
    ...
    {"FSR__plus", "PS_variation_FSRup_2"}, {"FSR__minus", "PS_variation_FSRdown_2"}};
  ...
  for ( const auto & JetCollection : JetCollections){
	...
	if(systematic.at(1).Contains("PS_variation") && !MCName.Contains("TTbar")) continue;
